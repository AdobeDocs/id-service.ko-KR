...
<table id="table_8E773F76DBCB4797A0C117080CA8707C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>H.27 </p> <p> <p>참고: <span class="keyword"> Analytics</span> s_code 버전 H.27은 ID 서비스 버전 1.6.0 릴리스에서 더 이상 지원되지 않습니다. 코드를 최신 버전의 AppMeasurement으로 업그레이드합니다. </p> </p> </td> 
  </tr> 
  <tr> 
