---
description: 이 섹션을 검토하여 Experience Cloud ID 서비스에 필요한 솔루션, 서비스 및 코드 버전을 사용하고 있는지 확인하십시오.
keywords: ID 서비스
seo-description: Experience Cloud ID 서비스에 필요한 올바른 솔루션, 서비스 및 쿠키 버전을 사용 중인지 확인하려면 이 섹션을 검토하십시오.
...
Experience Cloud ID 서비스에 필요한 올바른 솔루션, 서비스 및 쿠키 버전을 사용 중인지 확인하려면 이 섹션을 검토하십시오.
...
<table id="table_2216C44AA66248DCAA13BF64BDF2D88A"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../mcvid-implementation-guides/mcvid-standard.md#concept-89cd0199a9634fc48644f2d61e3d2445" format="dita" scope="local"> 표준</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../mcvid-implementation-guides/mcvid-implementation-guides.md#section-2c4f2db1f9704315a7cccab6d2e07113" format="dita" scope="local"> 비표준 구현 </a> </p> </td> 
...
>[!MORE_ like_ this]
>
>* [코드 라이브러리](../mcvid-library/mcvid-library.md#concept-ff27497375644a898d47984aefb21c97)
