...
* 동일한 도메인에서 추적을 보장하기 위해 고객 도메인에 퍼스트 파티 쿠키를 설정합니다. [Experience Cloud](../introduction/cookies.md)를 참조하십시오.
