...
keywords: ID 서비스
seo-description: Adobe Experience Cloud에서 Experience Cloud ID 서비스의 역할
seo-title: ID 서비스 정보
title: 개요
...
Adobe Experience Cloud에서 Experience Cloud ID 서비스의 역할
...
* 동일한 도메인에서 추적할 수 있도록 고객의 도메인에서 퍼스트 파트 쿠키를 설정합니다. 자세한 내용은 [Experience Cloud](../introduction/cookies.md).
