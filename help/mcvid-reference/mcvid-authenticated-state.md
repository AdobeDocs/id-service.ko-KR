...
선언된 ID를 [!DNL Audience Manager]에 전달하는 경우 `userid` 개체가 데이터 소스와 연결된 통합 코드와 일치해야 합니다. 자세한 내용은 [병합 규칙 코드 구성](https://marketing.adobe.com/resources/help/ko_KR/aam/?f=merge-rules-configure-code.html) 설명서의 [!DNL Visitor ID Service] 섹션을 참조하십시오.
