...
# 분석을 위한 경험 플랫폼 ID 서비스 구현 {#implement-the-experience-cloud-id-service-for-analytics}
...
추적 서버를 찾는 방법을 모를 경우 [FAQ를](../faq-intro/faq.md) 참조하고 [trackingserver 및 trackingserversecure 변수를 올바로](https://helpx.adobe.com/analytics/kb/determining-data-center.html#)채우십시오.
...
Experience Platform Identity Service [](../implementation-guides/test-verify.md)테스트 및 확인
