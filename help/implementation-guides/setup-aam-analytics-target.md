...
# Analytics, Audience Manager 및 Target에 대한 경험 플랫폼 ID 서비스 구현 {#implement-the-experience-cloud-id-service-for-analytics-audience-manager-and-target}
...
>[!IMPORTANT]
>
>시작하기 전에 ID 서비스 [요구 사항을](../reference/requirements.md) 읽고 이 구현과 관련된 다음 요구 사항을 참고하십시오. &gt;
...
## 4 단계: Experience Cloud 조직 ID를 Visitor. getinstance에 추가 {#section-e2947313492546789b0c3b2fc3e897d8}
...
이러한 사용 사례가 사용자의 상황에 적용되는 경우에는 [고객 지원 센터에](https://helpx.adobe.com/marketing-cloud/contact-support.html) 임시 [유예 기간을 설정하도록 요청하십시오](../reference/analytics-reference/grace-period.md). 유예 기간은 최대 180일 동안 실행할 수 있습니다. 필요한 경우 유예 기간을 갱신할 수 있습니다.
...
ID 서비스가 제대로 작동하는지 확인하는 데 도움이 되는 추가 확인은 Experience Platform Identity Service [테스트를 참조하고 확인하십시오](../implementation-guides/test-verify.md).
