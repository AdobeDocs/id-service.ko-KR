...
**옵트인 서비스**&#x200B;입니다. 옵트인은 CX 엔터프라이즈 라이브러리에서 방문자 웹 페이지에 쿠키를 생성할 수 있는지 여부를 제어할 수 있는 ECID의 확장 기능입니다. [태그](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=ko)를 사용하면 Analytics, Target, Audience Manager 등을 활성화하여 CX 엔터프라이즈 솔루션에 대한 방문자 옵트인 동의를 수집하거나, 동의 관리 시스템에 옵트인할 CX 엔터프라이즈 솔루션을 모두 선택할 수 있습니다.
