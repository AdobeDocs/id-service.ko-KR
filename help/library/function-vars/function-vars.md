---
description: 이러한 속성을 Visitor.getInstance 정적 메서드에 전달하여 방문자 ID 서비스를 구성합니다.
keywords: IMS 조직 ID;방문자 ID 서비스
title: 구성
...
이러한 속성을 Visitor.getInstance 정적 메서드에 전달하여 방문자 ID 서비스를 구성합니다.
