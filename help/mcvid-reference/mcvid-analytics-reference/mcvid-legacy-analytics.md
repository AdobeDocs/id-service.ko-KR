 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>s_vi 쿠키가 있는 사이트 방문자가 Experience Cloud ID 서비스를 처음 접하면 이 서비스는 다음을 수행합니다. </p> 
    ...
    </ul> <p> <p>참고: <a href="../../mcvid-reference/mcvid-analytics-reference/mcvid-grace-period.md" format="dita" scope="local">유예 기간</a>을 사용할 경우 데이터 센터 응답에는 항상 s_vi 쿠키에 저장된 이전 ID가 포함됩니다. 유예 기간 동안 이전 ID가 AMCV 쿠키에 AID 값으로 기록됩니다. </p> </p> </td> 
  </tr> 
 </tbody> 
</table>
