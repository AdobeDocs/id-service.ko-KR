...
또한 CNAME 구현을 통해 다음을 수행할 수 있습니다 [사용자 지정 RDC 유형 선택](https://experienceleague.adobe.com/docs/analytics/technotes/rdc/regional-data-collection.html?lang=ko-KR) 는 사용자의 히트가 처음에 라우팅되는 위치를 제어합니다. 대부분의 고객은 사용자 정의 RDC 유형을 사용하지 않습니다.
