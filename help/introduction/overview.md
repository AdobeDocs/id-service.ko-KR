...
seo-description: Experience Platform Identity Service를 통해 Experience Cloud 핵심 서비스, 솔루션, 고객 특성 및 고객에 대한 일반적인 식별 프레임워크를 사용할 수 있습니다.
seo-title: ID 서비스 개요
title: 개요
uuid: null
...
Experience Platform Identity Service를 사용하면 Experience Cloud 핵심 서비스, 솔루션 및 플랫폼 ID 서비스의 고객 특성과 고객에 대한 공통 식별 프레임워크를 사용할 수 있습니다. (Experience Cloud ID 서비스, ECID, Marketing Cloud ID 서비스, MID, 방문자 ID 서비스 등 이전 이름이나 약어에 대한 참조가 표시될 수 있습니다.) ID 서비스는 고유 영구 ID를 사이트 방문자에게 할당하는 방식으로 작동합니다. 조직에서 ID 서비스를 구현하면 이 ID를 통해 다른 Experience Cloud 솔루션에서 동일한 사이트 방문자와 해당 데이터를 식별할 수 있습니다.
