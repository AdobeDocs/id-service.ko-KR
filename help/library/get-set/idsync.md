...
다음 테이블은 두 함수 모두에서 사용할 수 있는 속성을 나열하고 정의합니다.
...
>[!MORELIKETHIS]
>
>* [DIL idSync](https://experienceleague.adobe.com/docs/audience-manager/user-guide/dil-api/dil-instance-methods.html?lang=ko-KR#idsync)
